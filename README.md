[![Typing SVG](https://readme-typing-svg.herokuapp.com/?color=003366&size=35&center=true&vCenter=true&width=1500&lines=Hello+World!;Sou+Pedro+Janneo,+Desenvolvedor+Backend+Júnior+em+Java/Spring+Boot.;Seja+Bem-vindo!)](https://git.io/typing-svg)
...
Aplicação backend para gerenciamento de dívidas entre amigos, com notificações automáticas.  
- **Stack:** Java, Spring Boot, MySQL, Twilio, Stripe  
- **Diferencial:** integração com APIs externas reais e estrutura backend escalável  
- **Impacto:** consolidação de conceitos de arquitetura backend, regras de negócio e integração de serviços

🔹 **[BookStore – Java](https://github.com/PedroJanneo/bookstore-java)**  
Sistema de livraria desenvolvido em Java.  
- **Stack:** Java (Spring Boot), MySQL  
- **Diferencial:** projeto originalmente em Node.js, reescrito em Java para aprofundar conhecimentos na stack  
- **Resultado:** melhoria na organização do código, separação de responsabilidades e adoção de padrões do Spring

---

## 🌱 Atualmente aprendendo
- Java avançado e boas práticas com Spring Boot  
- Testes unitários e de integração com **JUnit 5 e Mockito**  
- Integração contínua e deploy com **GitHub Actions**  
- Noções de cloud (**AWS / Azure**)

---

## 📫 Como me encontrar
[![LinkedIn](https://img.shields.io/badge/LinkedIn-blue?logo=linkedin&logoColor=white)](http://www.linkedin.com/in/pedrojanneo)  
[![Portfólio](https://img.shields.io/badge/Portfólio-green?logo=vercel&logoColor=white)](https://portifolio-pedro-janneo.vercel.app)
